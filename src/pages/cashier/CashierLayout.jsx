...
const CashierLayout = () => {
  ...
  const handleLogout = () => {
    showAlert.error('تسجيل الخروج', 'هل أنت متأكد من رغبتك في الخروج من النظام؟').then((result) => {
        ...
        {isDashboard && (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-black text-xl sm:text-2xl tracking-tight leading-none">دكاني</h1>
                <p className="text-[9px] sm:text-[10px] font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider mt-1">نقطة البيع</p>
              </div>
            </div>
